...
namespace Horizon_EOBS_Parse
{
    public class NParse_AbilTO
    {
        ...
        public string printCSV( )
        {
            ...
            string directory = @"C:\CierantProjects_dataLocal\Horizon_Parse\DailyFiles\2016-01-14\AbilTo";
            string strsql = "select distinct filename from HOR_parse_AbilTO where convert(date,dateimport) = '2016-1-14'";
            string strsql2 = "";
