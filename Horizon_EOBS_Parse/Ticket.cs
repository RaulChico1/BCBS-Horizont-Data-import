    ...
    public class Ticket
    {
        public void createTicket(DataTable dataToTicket, string location, string ticketNO)
        {
            ...
            try
            {
                ...
                string FileNAME_network = @"\\freenas\clients\Horizon BCBS\NoticeLetters\JobTickets\" + "Job Ticket_" + ticketNO + "_" + GlobalVar.DateofProcess.ToString("yyyy_MM_dd") + ".xls";
                ...
                sendmail.SendMail("Horizon BCBS Daily Ticket " + ticketNO + " Ready  EOM", "rchico@apps.cierant.com,kcarpenter@apps.cierant.com,cgaytan@apps.cierant.com",
