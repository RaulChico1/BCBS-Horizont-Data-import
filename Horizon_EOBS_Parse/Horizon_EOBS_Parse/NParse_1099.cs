    ...
    public class NParse_1099
    {
         ...
         public string ProcessFiles(string dateProcess)
         {
             ...
             foreach (DataRow row in d1099.Rows)
             {
                 ...
                 else if (Convert.ToInt16(row["Index"].ToString()) > 1 && Convert.ToInt16(row["Index"].ToString()) < 14)
                 {
         ...
         private static DataTable Data_Table()
         {
             ...
             newt.Columns.Add("CustCCID13");
             newt.Columns.Add("FirstName13");
             newt.Columns.Add("LastName13");
             newt.Columns.Add("SubCode13");
             newt.Columns.Add("DOB13");
             newt.Columns.Add("MainGrp13");
             newt.Columns.Add("UppEffdate13");
             newt.Columns.Add("UppTermDate13");
             newt.Columns.Add("Jan13");
             newt.Columns.Add("Feb13");
             newt.Columns.Add("Mar13");
             newt.Columns.Add("Apr13");
             newt.Columns.Add("May13");
             newt.Columns.Add("Jun13");
             newt.Columns.Add("Jul13");
             newt.Columns.Add("Aug13");
             newt.Columns.Add("Sep13");
             newt.Columns.Add("Oct13");
             newt.Columns.Add("Nov13");
             newt.Columns.Add("Dec13");
             newt.Columns.Add("FyllYear13");
