...
namespace Horizon_EOBS_Parse
{
    public class createEmail
    {
        ...
        public void produceSummary_Uploaded()
        {
            ...
            string strsqll = "select z.ZipName, z.ZipCount, z.csvNames as [CSVs],ISNULL(L.field1,L2.Field1) as 'Status', z.txtNames as [TXTs] from HOR_parse_Log_Zips Z " +
            ...
            emailAgain:
                SendMails sendmail = new SendMails();
                resultsEmail = sendmail.SendMail("Uploads to CaptainCrunch " + DateTime.Now.ToString("yyyy-MM-dd"), "jcioban@apps.cierant.com,bdumont@apps.cierant.com, rchico@apps.cierant.com,cgaytan@apps.cierant.com" +
                    ",aaltamirano@sciimage.com,rconte@sciimage.com,pgnecco@sciimage.com,mscherman@sciimage.com,kcarpenter@apps.cierant.com,hcedeno@sciimage.com,ckearney@sciimage.com",
                                            "noreply@apps.cierant.com", "\n\n" +
                                             strHTMLBuilder);
                if(resultsEmail != "")
                {
                    ...
                    {
                        SendMails sendmailMobil = new SendMails();
                        for (int i = 0; i < 10; i++)
                        {
                            sendmailMobil.SendMailFatalError("Horizon can not sent mail", "End of process", "UPLOAD email ", "");
                        }
        ...
        public void produceSummary_ID_NON_Maintenence(string LocalDirectory)
        {
            ...
            if (processedData.Rows.Count > 0)
            {
                ...
                //================
                SendMails sendmail = new SendMails();
                sendmail.SendMail("ID Cards Uploaded to CaptainCrunch " + DateTime.Now.ToString("yyyy-MM-dd"), "rchico@apps.cierant.com,tkrompinger@apps.cierant.com, cgaytan@apps.cierant.com,pgnecco@sciimage.com,edymek@sciimage.com,jnunez@sciimage.com",
                    //sendmail.SendMail("Pre Sales Kits Upload", "rchico@apps.cierant.com",
                                            "noreply@apps.cierant.com", "\n\n" +
                                             strHTMLBuilder);  //tkrompinger@apps.cierant.com
        ...
        public void specific_error_cycle(string title, string msg)
        {
            SendMails sendmailTxt = new SendMails();
            sendmailTxt.SendMail(title, "2038086157@tmomail.net",
                                        "noreply@apps.cierant.com", "\n\n" +
                                         msg);  
