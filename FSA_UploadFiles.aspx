<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FSA_UploadFiles.aspx.cs" Inherits="FSA_UploadFiles" %>
    ...
    <div id="rpt1" style="width: 42%; height: 300px; display: inline-block;">
        <div id="filesXML" style="overflow: scroll; width: 100%; height: 259px">
            <div>
                ...
                <asp:Button ID="Button1" runat="server" Text="  Upload some files (not ready yet)"
                    OnClick="UploadFiles"
                    class="dropdown2" />
