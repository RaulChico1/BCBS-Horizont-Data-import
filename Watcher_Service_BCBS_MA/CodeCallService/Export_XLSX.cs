   ...
   public class Export_XLSX
    {
        ...
        {
            {
                ...
                string FileNAME_network = @"\\Cierant-taper\clients\Horizon BCBS\NoticeLetters\JobTickets\" + "Job Ticket_" + ticketNO + "_" + GlobalVar.DateofProcess.ToString("yyyy_MM_dd__") + xx + ".xlsx";
        ...
        public void CreateExcelFileOneTables(DataTable dataTo1, string Name1, string location)
        {
            {
                int totalRecs = dataTo1.Rows.Count;
