    ...
    public class Ticket
    {
        public void createTicket(DataTable dataToTicket, string location, string ticketNO)
        {
            ...
            try
            {
                ...
                sendmail.SendMail("Horizon BCBS Daily Ticket " + ticketNO + " Ready  EOM", "rchico@apps.cierant.com,kcarpenter@apps.cierant.com,kmcnamara@apps.cierant.com,stilford@apps.cierant.com,snelson@apps.cierant.com,cgaytan@apps.cierant.com",
